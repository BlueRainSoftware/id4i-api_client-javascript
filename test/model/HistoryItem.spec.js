...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Id4iApi.HistoryItem();
  });
  ...
  describe('HistoryItem', function() {
    it('should create an instance of HistoryItem', function() {
      // uncomment below and update the code to test HistoryItem
      //var instane = new Id4iApi.HistoryItem();
      //expect(instance).to.be.a(Id4iApi.HistoryItem);
    });
