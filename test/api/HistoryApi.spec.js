...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Id4iApi.HistoryApi();
  });
  ...
  describe('HistoryApi', function() {
    ...
    describe('updateItemVisibility', function() {
      it('should call updateItemVisibility successfully', function(done) {
        //uncomment below and update the code to test updateItemVisibility
        //instance.updateItemVisibility(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
