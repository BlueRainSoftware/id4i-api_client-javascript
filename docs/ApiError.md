...
* `INSECURE_PASSWORD_LENGTH` (value: `"ERR_INSECURE_PASSWORD_LENGTH"`)

* `INSECURE_PASSWORD_CHARACTER_CLASSES` (value: `"ERR_INSECURE_PASSWORD_CHARACTER_CLASSES"`)

* `INSECURE_PASSWORD_PATTERN` (value: `"ERR_INSECURE_PASSWORD_PATTERN"`)

* `INSECURE_PASSWORD_SAME` (value: `"ERR_INSECURE_PASSWORD_SAME"`)

* `INSECURE_PASSWORD_COMMON` (value: `"ERR_INSECURE_PASSWORD_COMMON"`)
