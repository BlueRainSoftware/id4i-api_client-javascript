...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountCredentials', 'model/AddApiKeyPrivilegeRequest', 'model/ApiError', 'model/ApiKeyChangeRequest', 'model/ApiKeyCreationRequest', 'model/ApiKeyPresentation', 'model/ApiKeyPrivilege', 'model/ApiKeyPrivilegeInfo', 'model/ApiKeyPrivilegeInfoResponse', 'model/ApiKeyPrivilegePaginatedResponse', 'model/AppInfoPresentation', 'model/ChangeRoleRequest', 'model/CompleteUserRegistrationRequest', 'model/Country', 'model/CreateGuidRequest', 'model/CreateLabelledCollectionRequest', 'model/CreateLogisticCollectionRequest', 'model/CreateRoutingCollectionRequest', 'model/File', 'model/Guid', 'model/GuidAlias', 'model/GuidCollection', 'model/Id4n', 'model/Id4nPresentation', 'model/Id4nPresentationPaginatedResponse', 'model/InputStream', 'model/InputStreamResource', 'model/ListOfId4ns', 'model/Organization', 'model/OrganizationAddress', 'model/OrganizationUserInvitation', 'model/OrganizationUserInvitationListRequest', 'model/PaginatedApiKeyResponse', 'model/PaginatedCountryResponse', 'model/PaginatedGuidCollection', 'model/PaginatedGuidResponse', 'model/PaginatedOrganizationResponse', 'model/PaginatedResponseApiKeyPresentation', 'model/PaginatedResponseApiKeyPrivilege', 'model/PaginatedResponseApiKeyPrivilegeInfo', 'model/PaginatedResponseCountry', 'model/PaginatedResponseGuid', 'model/PaginatedResponseGuidCollection', 'model/PaginatedResponseId4nPresentation', 'model/PaginatedResponseOrganization', 'model/PaginatedResponseRole', 'model/PaginatedResponseUserPresentation', 'model/PaginatedResponseUserRoles', 'model/PaginatedResponsestring', 'model/PaginatedStringResponse', 'model/PaginatedUserPresentationResponse', 'model/PaginatedUserRolesResponse', 'model/PasswordResetRequest', 'model/PasswordResetVerificationRequest', 'model/RegistrationVerificationTokenPresentation', 'model/RemoveApiKeyPrivilegeRequest', 'model/Role', 'model/RoleResponse', 'model/Route', 'model/RoutingFile', 'model/RoutingFileRequest', 'model/RoutingOptions', 'model/SimpleMessageResponse', 'model/Timestamp', 'model/URI', 'model/URL', 'model/UserPresentation', 'model/UserRegistrationRequest', 'model/UserRegistrationResponse', 'model/UserRoles', 'model/WhoIsResponse', 'api/AccountsApi', 'api/AliasApi', 'api/ApiKeysApi', 'api/CollectionsApi', 'api/GUIDsApi', 'api/ImagesApi', 'api/MetaInformationApi', 'api/MicrostorageApi', 'api/OrganizationsApi', 'api/PublicServicesApi', 'api/RoutingApi', 'api/WhoIsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AccountCredentials'), require('./model/AddApiKeyPrivilegeRequest'), require('./model/ApiError'), require('./model/ApiKeyChangeRequest'), require('./model/ApiKeyCreationRequest'), require('./model/ApiKeyPresentation'), require('./model/ApiKeyPrivilege'), require('./model/ApiKeyPrivilegeInfo'), require('./model/ApiKeyPrivilegeInfoResponse'), require('./model/ApiKeyPrivilegePaginatedResponse'), require('./model/AppInfoPresentation'), require('./model/ChangeRoleRequest'), require('./model/CompleteUserRegistrationRequest'), require('./model/Country'), require('./model/CreateGuidRequest'), require('./model/CreateLabelledCollectionRequest'), require('./model/CreateLogisticCollectionRequest'), require('./model/CreateRoutingCollectionRequest'), require('./model/File'), require('./model/Guid'), require('./model/GuidAlias'), require('./model/GuidCollection'), require('./model/Id4n'), require('./model/Id4nPresentation'), require('./model/Id4nPresentationPaginatedResponse'), require('./model/InputStream'), require('./model/InputStreamResource'), require('./model/ListOfId4ns'), require('./model/Organization'), require('./model/OrganizationAddress'), require('./model/OrganizationUserInvitation'), require('./model/OrganizationUserInvitationListRequest'), require('./model/PaginatedApiKeyResponse'), require('./model/PaginatedCountryResponse'), require('./model/PaginatedGuidCollection'), require('./model/PaginatedGuidResponse'), require('./model/PaginatedOrganizationResponse'), require('./model/PaginatedResponseApiKeyPresentation'), require('./model/PaginatedResponseApiKeyPrivilege'), require('./model/PaginatedResponseApiKeyPrivilegeInfo'), require('./model/PaginatedResponseCountry'), require('./model/PaginatedResponseGuid'), require('./model/PaginatedResponseGuidCollection'), require('./model/PaginatedResponseId4nPresentation'), require('./model/PaginatedResponseOrganization'), require('./model/PaginatedResponseRole'), require('./model/PaginatedResponseUserPresentation'), require('./model/PaginatedResponseUserRoles'), require('./model/PaginatedResponsestring'), require('./model/PaginatedStringResponse'), require('./model/PaginatedUserPresentationResponse'), require('./model/PaginatedUserRolesResponse'), require('./model/PasswordResetRequest'), require('./model/PasswordResetVerificationRequest'), require('./model/RegistrationVerificationTokenPresentation'), require('./model/RemoveApiKeyPrivilegeRequest'), require('./model/Role'), require('./model/RoleResponse'), require('./model/Route'), require('./model/RoutingFile'), require('./model/RoutingFileRequest'), require('./model/RoutingOptions'), require('./model/SimpleMessageResponse'), require('./model/Timestamp'), require('./model/URI'), require('./model/URL'), require('./model/UserPresentation'), require('./model/UserRegistrationRequest'), require('./model/UserRegistrationResponse'), require('./model/UserRoles'), require('./model/WhoIsResponse'), require('./api/AccountsApi'), require('./api/AliasApi'), require('./api/ApiKeysApi'), require('./api/CollectionsApi'), require('./api/GUIDsApi'), require('./api/ImagesApi'), require('./api/MetaInformationApi'), require('./api/MicrostorageApi'), require('./api/OrganizationsApi'), require('./api/PublicServicesApi'), require('./api/RoutingApi'), require('./api/WhoIsApi'));
  }
}(function(ApiClient, AccountCredentials, AddApiKeyPrivilegeRequest, ApiError, ApiKeyChangeRequest, ApiKeyCreationRequest, ApiKeyPresentation, ApiKeyPrivilege, ApiKeyPrivilegeInfo, ApiKeyPrivilegeInfoResponse, ApiKeyPrivilegePaginatedResponse, AppInfoPresentation, ChangeRoleRequest, CompleteUserRegistrationRequest, Country, CreateGuidRequest, CreateLabelledCollectionRequest, CreateLogisticCollectionRequest, CreateRoutingCollectionRequest, File, Guid, GuidAlias, GuidCollection, Id4n, Id4nPresentation, Id4nPresentationPaginatedResponse, InputStream, InputStreamResource, ListOfId4ns, Organization, OrganizationAddress, OrganizationUserInvitation, OrganizationUserInvitationListRequest, PaginatedApiKeyResponse, PaginatedCountryResponse, PaginatedGuidCollection, PaginatedGuidResponse, PaginatedOrganizationResponse, PaginatedResponseApiKeyPresentation, PaginatedResponseApiKeyPrivilege, PaginatedResponseApiKeyPrivilegeInfo, PaginatedResponseCountry, PaginatedResponseGuid, PaginatedResponseGuidCollection, PaginatedResponseId4nPresentation, PaginatedResponseOrganization, PaginatedResponseRole, PaginatedResponseUserPresentation, PaginatedResponseUserRoles, PaginatedResponsestring, PaginatedStringResponse, PaginatedUserPresentationResponse, PaginatedUserRolesResponse, PasswordResetRequest, PasswordResetVerificationRequest, RegistrationVerificationTokenPresentation, RemoveApiKeyPrivilegeRequest, Role, RoleResponse, Route, RoutingFile, RoutingFileRequest, RoutingOptions, SimpleMessageResponse, Timestamp, URI, URL, UserPresentation, UserRegistrationRequest, UserRegistrationResponse, UserRoles, WhoIsResponse, AccountsApi, AliasApi, ApiKeysApi, CollectionsApi, GUIDsApi, ImagesApi, MetaInformationApi, MicrostorageApi, OrganizationsApi, PublicServicesApi, RoutingApi, WhoIsApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The MicrostorageApi service constructor.
     * @property {module:api/MicrostorageApi}
     */
    MicrostorageApi: MicrostorageApi,
    /**
