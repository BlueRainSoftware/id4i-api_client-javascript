...
(function(root, factory) {
   ...
   * @param nextScanOwnership {Boolean} Allow anyone which scans or knows the ID4N to obtain this object
   * @param recipientOrganizationIds {Array.<Number>} Allow only these organizations to obtain this object
   */
  var exports = function(keepOwnership, nextScanOwnership, recipientOrganizationIds) {
    var _this = this;


    _this['keepOwnership'] = keepOwnership;
    _this['nextScanOwnership'] = nextScanOwnership;
