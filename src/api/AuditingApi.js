...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiError', 'model/PaginatedResponseOfChangeLogEntry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiError'), require('../model/PaginatedResponseOfChangeLogEntry'));
  } else {
    // Browser globals (root is window)
    if (!root.Id4iApi) {
      root.Id4iApi = {};
    }
    root.Id4iApi.AuditingApi = factory(root.Id4iApi.ApiClient, root.Id4iApi.ApiError, root.Id4iApi.PaginatedResponseOfChangeLogEntry);
  }
}(this, function(ApiClient, ApiError, PaginatedResponseOfChangeLogEntry) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.listOrganizationChangeLog = function(organizationId, opts, callback) {
      ...
      var returnType = PaginatedResponseOfChangeLogEntry;
