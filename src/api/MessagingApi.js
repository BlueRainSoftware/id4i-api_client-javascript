...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiError', 'model/QueuePresentation', 'model/QueueUpdateRequest', 'model/SendCustomMessage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiError'), require('../model/QueuePresentation'), require('../model/QueueUpdateRequest'), require('../model/SendCustomMessage'));
  } else {
    // Browser globals (root is window)
    if (!root.Id4iApi) {
      root.Id4iApi = {};
    }
    root.Id4iApi.MessagingApi = factory(root.Id4iApi.ApiClient, root.Id4iApi.ApiError, root.Id4iApi.QueuePresentation, root.Id4iApi.QueueUpdateRequest, root.Id4iApi.SendCustomMessage);
  }
}(this, function(ApiClient, ApiError, QueuePresentation, QueueUpdateRequest, SendCustomMessage) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/SendCustomMessage} request request
     ...
     */
    this.enqueueCustomMessage = function(organizationId, request, callback) {
      ...
      if (request === undefined || request === null) {
        throw new Error("Missing the required parameter 'request' when calling enqueueCustomMessage");
      }
