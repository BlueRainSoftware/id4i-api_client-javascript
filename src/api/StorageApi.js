...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiError', 'model/Document', 'model/DocumentUpdate', 'model/PaginatedDocumentResponse', 'model/ResponseEntity'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiError'), require('../model/Document'), require('../model/DocumentUpdate'), require('../model/PaginatedDocumentResponse'), require('../model/ResponseEntity'));
  } else {
    // Browser globals (root is window)
    if (!root.Id4iApi) {
      root.Id4iApi = {};
    }
    root.Id4iApi.StorageApi = factory(root.Id4iApi.ApiClient, root.Id4iApi.ApiError, root.Id4iApi.Document, root.Id4iApi.DocumentUpdate, root.Id4iApi.PaginatedDocumentResponse, root.Id4iApi.ResponseEntity);
  }
}(this, function(ApiClient, ApiError, Document, DocumentUpdate, PaginatedDocumentResponse, ResponseEntity) {
  'use strict';
