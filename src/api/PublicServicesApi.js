...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiError', 'model/Document', 'model/Organization', 'model/PaginatedDocumentResponse', 'model/PaginatedHistoryItemResponse', 'model/Route', 'model/WhoIsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiError'), require('../model/Document'), require('../model/Organization'), require('../model/PaginatedDocumentResponse'), require('../model/PaginatedHistoryItemResponse'), require('../model/Route'), require('../model/WhoIsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Id4iApi) {
      root.Id4iApi = {};
    }
    root.Id4iApi.PublicServicesApi = factory(root.Id4iApi.ApiClient, root.Id4iApi.ApiError, root.Id4iApi.Document, root.Id4iApi.Organization, root.Id4iApi.PaginatedDocumentResponse, root.Id4iApi.PaginatedHistoryItemResponse, root.Id4iApi.Route, root.Id4iApi.WhoIsResponse);
  }
}(this, function(ApiClient, ApiError, Document, Organization, PaginatedDocumentResponse, PaginatedHistoryItemResponse, Route, WhoIsResponse) {
  'use strict';
