...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Id4iApi.PublicServicesApi = factory(root.Id4iApi.ApiClient, root.Id4iApi.ApiError, root.Id4iApi.ResponseEntity);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/PublicServicesApi~forwardUsingGETCallback
     ...
     * @param {module:api/PublicServicesApi~forwardUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the resolveHTMLUsingGET operation.
     * @callback module:api/PublicServicesApi~resolveHTMLUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.authorization Authorization JWT Bearer Token as returned from /login
     * @param {String} opts.acceptLanguage Requested language
     * @param {module:api/PublicServicesApi~resolveHTMLUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link 'String'}
     */
    this.resolveHTMLUsingGET = function(id4n, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id4n' is set
      if (id4n === undefined || id4n === null) {
        throw new Error("Missing the required parameter 'id4n' when calling resolveHTMLUsingGET");
      }
      ...
      var authNames = [];
      var contentTypes = ['application/xml', 'application/json;charset=UTF-8'];
      var accepts = ['application/xml', 'text/html', 'application/json;charset=UTF-8'];
