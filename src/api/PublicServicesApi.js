...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiError', 'model/ResponseEntity', 'model/WhoIsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiError'), require('../model/ResponseEntity'), require('../model/WhoIsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Id4iApi) {
      root.Id4iApi = {};
    }
    root.Id4iApi.PublicServicesApi = factory(root.Id4iApi.ApiClient, root.Id4iApi.ApiError, root.Id4iApi.ResponseEntity, root.Id4iApi.WhoIsResponse);
  }
}(this, function(ApiClient, ApiError, ResponseEntity, WhoIsResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/PublicServicesApi~resolveWhoIsEntryUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.authorization Authorization JWT Bearer Token as returned from /login
     * @param {String} opts.acceptLanguage Requested language
     * @param {module:api/PublicServicesApi~resolveWhoIsEntryUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
