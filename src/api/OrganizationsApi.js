...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/AddPartnerRequest} request request
     ...
     */
    this.addPartnerOrganization = function(organizationId, request, callback) {
      ...
      if (request === undefined || request === null) {
        throw new Error("Missing the required parameter 'request' when calling addPartnerOrganization");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PaginatedResponsePartnerOrganization} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PaginatedResponsePartnerOrganization}
     */
    this.getPartnerOrganizations = function(organizationId, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = ['application/xml', 'application/json'];
      var accepts = ['application/xml', 'application/json'];
      var returnType = PaginatedResponsePartnerOrganization;
     ...
     * @param {String} organizationId The namespace of the organization
     * @param {module:model/RemovePartnerRequest} request request
     ...
     */
    this.removePartnerOrganization = function(organizationId, request, callback) {
      var postBody = request;
      ...
      // verify the required parameter 'request' is set
      if (request === undefined || request === null) {
        throw new Error("Missing the required parameter 'request' when calling removePartnerOrganization");
      }
